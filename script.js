    ...
    if (document.getElementById("edit-form")) {
        ...
        fields.forEach(field => {
            ...
            if (inputElement) {
                if (inputElement.type === "checkbox") {
                    inputElement.checked = localStorage.getItem(field) === "true";
                } else {
                    inputElement.value = localStorage.getItem(field) || "";
                }
            }
        ...
        document.getElementById("edit-form").addEventListener("submit", function (e) {
            ...
            fields.forEach(field => {
                ...
                if (inputElement) {
                    if (inputElement.type === "checkbox") {
                        localStorage.setItem(field, inputElement.checked);
                    } else {
                        localStorage.setItem(field, inputElement.value.trim());
                    }
                }
        ...
        fields.forEach(field => {
            ...
            if (cell) {
                ...
                if (field.startsWith("task")) {
                    cell.innerText = storedValue === "true" ? "✓" : "";
                } else if (storedValue && storedValue.trim() !== "") {
                    cell.innerText = storedValue;
                } else {
                    cell.parentElement.style.display = "none"; // Hide empty rows
                }
